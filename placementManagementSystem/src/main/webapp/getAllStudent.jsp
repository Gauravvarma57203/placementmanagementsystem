    ...
    <table id="mytable">
        ...
        <tbody>
  			 ...
  			 <tr>
				...
				<td><a href="updateCompany.jsp?id=<%= s.getRollnumber()%>" class="btn btn-class">Update</a></td>
  		      
  		      
  		     
  		       <td> <input type="submit"   class="btn btn-outline-danger" id="delete-button"> Delete</a></td>
